...
The Station controller represent the global controller of all the gaz station.


\subsubsection*{Gas Pump}
The Gas pump represent the controller of a gas pump.
\begin{itemize}
...
The Management represent the management part of the application in which the payment for exemple while be manage.
\begin{itemize}
...
\item{Payment controller :} Allow the customer to make a payment.
\item{Customer :} Represent a customer with the different fields needed
\item{Account :} Compute the account of a purchase
\item{Credit transaction :} Represent a transaction with a credit card. 
\item{Credit payment :} Allow to pay with the credit card
\item{Credit purchase :} Add the purchase to the credit account.
\item{Account purchase :} Payment of the balance of the account 
\item{Cash purchase :} Management of the purchase with cash
\end{itemize}
